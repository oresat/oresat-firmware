...
// use timer 6 as trigger
// see ref manual 14.10.1 'DAC Control Register'
#define TMR_6_DAC_TRGR 0

static const DACConversionGroup dacgrpcfg1 = {
  .num_channels = 1U,
  .end_cb       = end_cb1,
  .error_cb     = error_cb1,
  .trigger      = DAC_TRG(TMR_6_DAC_TRGR)
};
...
static void app_init(void)
{
    ...
    init_worker(&dac_thr, "test the dac", dac_da, sizeof(dac_da), NORMALPRIO, dac_test, NULL);
    reg_worker(&dac_thr);
