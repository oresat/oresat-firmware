...
#define BMI088_ACC_SOFTRESET_Msk            (0xB6 << BMI088_ACC_SOFTRESET_Pos)
#define BMI088_ACC_SOFTRESET                BMI088_ACC_SOFTRESET_Msk
#define BMI088_ACC_POWER_CONTROL_Pos        ()
#define BMI088_ACC_POWER_CONTROL_Msk        ()
#define BMI088_ACC_POWER_CONTROL            BMI088_ACC_POWER_CONTROL_Msk
#define BMI088_ACC_POWER_CONF_Pos           ()
#define BMI088_ACC_POWER_CONF_Msk           ()
#define BMI088_ACC_POWER_CONF               BMI088_POWER_CONF_Msk
#define BMI088_ACC_SELF_TEST_Pos            ()
#define BMI088_ACC_SELF_TEST_Msk            ()
#define BMI088_ACC_SELF_TEST                BMI088_SELF_TEST_Msk    
#define BMI088_ACC_INT1_MAP_DATA_Pos        ()
#define BMI088_ACC_INT1_MAP_DATA_Msk        ()
#define BMI088_ACC_INT1_MAP_DATA            BMI088_ACC_INT1_MAP_DATA_Msk
#define BMI088_ACC_INT2_MAP_DATA_Pos        ()
#define BMI088_ACC_INT2_MAP_DATA_Msk        ()
#define BMI088_ACC_INT2_MAP_DATA            BMI088_ACC_INT2_MAP_DATA_Msk
#define BMI088_ACC_INT1_IO_CONF_Pos         ()
