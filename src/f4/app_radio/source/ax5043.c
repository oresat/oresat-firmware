...
void ax5043_set_regs(SPIDriver * spip) {
    ...
    ax5043SPIWriteRegister(spip, AX5043_REG_ENCODING,       (uint8_t)0x07, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_FRAMING,        (uint8_t)0x14, rxbuf);
    //ax5043SPIWriteRegister(spip, AX5043_REG_FEC,          (uint8_t)0x13, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_CRCINIT3,       (uint8_t)0x00, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_CRCINIT2,       (uint8_t)0x00, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_CRCINIT1,       (uint8_t)0xFF, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_CRCINIT0,       (uint8_t)0xFF, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_PINFUNCSYSCLK,  (uint8_t)0x01, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_PINFUNCDCLK,    (uint8_t)0x01, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_PINFUNCDATA,    (uint8_t)0x01, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_PINFUNCANTSEL,  (uint8_t)0x01, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_PINFUNCPWRAMP,  (uint8_t)0x07, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_WAKEUPXOEARLY,  (uint8_t)0x01, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_IFFREQ1,        (uint8_t)0x02, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_IFFREQ0,        (uint8_t)0x0C, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_DECIMATION,     (uint8_t)0x14, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_RXDATARATE2,    (uint8_t)0x00, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_RXDATARATE1,    (uint8_t)0x3E, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_RXDATARATE0,    (uint8_t)0x80, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_MAXDROFFSET2,   (uint8_t)0x00, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_MAXDROFFSET1,   (uint8_t)0x00, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_MAXDROFFSET0,   (uint8_t)0x00, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_MAXRFOFFSET2,   (uint8_t)0x80, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_MAXRFOFFSET1,   (uint8_t)0x01, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_MAXRFOFFSET0,   (uint8_t)0x2F, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_FSKDMAX1,       (uint8_t)0x00, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_FSKDMAX0,       (uint8_t)0xA6, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_FSKDMIN1,       (uint8_t)0xFF, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_FSKDMIN0,       (uint8_t)0x5A, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_AMPLFILTER,     (uint8_t)0x00, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_RXPARAMSETS,    (uint8_t)0xF4, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_AGCGAIN0,       (uint8_t)0xC5, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_AGCTARGET0,     (uint8_t)0x84, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_TIMEGAIN0,      (uint8_t)0xF8, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_DRGAIN0,        (uint8_t)0xF2, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_PHASEGAIN0,     (uint8_t)0xC3, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_FREQUENCYGAINA0,(uint8_t)0x0F, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_FREQUENCYGAINB0,(uint8_t)0x1F, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_FREQUENCYGAINC0,(uint8_t)0x0A, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_FREQUENCYGAIND0,(uint8_t)0x0A, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_AMPLITUDEGAIN0, (uint8_t)0x06, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_FREQDEV10,      (uint8_t)0x00, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_FREQDEV00,      (uint8_t)0x00, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_BBOFFSRES0,     (uint8_t)0x00, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_AGCGAIN1,       (uint8_t)0xC5, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_AGCTARGET1,     (uint8_t)0x84, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_AGCAHYST1,      (uint8_t)0x00, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_AGCMINMAX1,     (uint8_t)0x00, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_TIMEGAIN1,      (uint8_t)0xF6, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_DRGAIN1,        (uint8_t)0xF1, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_PHASEGAIN1,     (uint8_t)0xC3, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_FREQUENCYGAINA1,(uint8_t)0x0F, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_FREQUENCYGAINB1,(uint8_t)0x1F, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_FREQUENCYGAINC1,(uint8_t)0x0A, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_FREQUENCYGAIND1,(uint8_t)0x0A, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_AMPLITUDEGAIN1, (uint8_t)0x06, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_FREQDEV11,      (uint8_t)0x00, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_FREQDEV01,      (uint8_t)0x25, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_FOURFSK1,       (uint8_t)0x16, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_BBOFFSRES1,     (uint8_t)0x00, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_AGCGAIN3,       (uint8_t)0xFF, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_AGCTARGET3,     (uint8_t)0x84, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_AGCAHYST3,      (uint8_t)0x00, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_AGCMINMAX3,     (uint8_t)0x00, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_TIMEGAIN3,      (uint8_t)0xF5, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_DRGAIN3,        (uint8_t)0xF0, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_PHASEGAIN3,     (uint8_t)0xC3, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_FREQUENCYGAINA3,(uint8_t)0x0F, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_FREQUENCYGAINB3,(uint8_t)0x1F, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_FREQUENCYGAINC3,(uint8_t)0x0D, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_FREQUENCYGAIND3,(uint8_t)0x0D, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_AMPLITUDEGAIN3, (uint8_t)0x06, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_FREQDEV13,      (uint8_t)0x00, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_FREQDEV03,      (uint8_t)0x25, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_FOURFSK3,       (uint8_t)0x16, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_BBOFFSRES3,     (uint8_t)0x00, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_MODCFGF,        (uint8_t)0x02, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_FSKDEV2,        (uint8_t)0x00, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_FSKDEV1,        (uint8_t)0x04, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_FSKDEV0,        (uint8_t)0x5E, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_MODCFGA,        (uint8_t)0x05, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_TXRATE2,        (uint8_t)0x00, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_TXRATE1,        (uint8_t)0x0D, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_TXRATE0,        (uint8_t)0x1B, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_TXPWRCOEFFB1,   (uint8_t)0x07, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_TXPWRCOEFFB0,   (uint8_t)0x00, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_PLLVCOI,        (uint8_t)0x99, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_PLLRNGCLK,      (uint8_t)0x05, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_BBTUNE,         (uint8_t)0x0F, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_BBOFFSCAP,      (uint8_t)0x77, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_PKTADDRCFG,     (uint8_t)0x00, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_PKTLENCFG,      (uint8_t)0x00, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_PKTLENOFFSET,   (uint8_t)0x15, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_PKTMAXLEN,      (uint8_t)0xF0, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_MATCH0PAT3,     (uint8_t)0xAA, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_MATCH0PAT2,     (uint8_t)0xCC, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_MATCH0PAT1,     (uint8_t)0xAA, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_MATCH0PAT0,     (uint8_t)0xCC, rxbuf);
    //ax5043SPIWriteRegister(spip, AX5043_REG_MATCH0LEN,      (uint8_t)0x9F, rxbuf);
    //ax5043SPIWriteRegister(spip, AX5043_REG_MATCH0MAX,      (uint8_t)0x1F, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_MATCH1PAT1,     (uint8_t)0x55, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_MATCH1PAT0,     (uint8_t)0x55, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_MATCH1LEN,      (uint8_t)0x0A, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_MATCH1MAX,      (uint8_t)0x0A, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_TMGTXBOOST,     (uint8_t)0x5B, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_TMGTXSETTLE,    (uint8_t)0x3E, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_TMGRXBOOST,     (uint8_t)0x5B, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_TMGRXSETTLE,    (uint8_t)0x3E, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_TMGRXOFFSACQ,   (uint8_t)0x00, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_TMGRXCOARSEAGC, (uint8_t)0x9C, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_TMGRXRSSI,      (uint8_t)0x03, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_TMGRXPREAMBLE2, (uint8_t)0x17, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_RSSIABSTHR,     (uint8_t)0xE3, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_BGNDRSSITHR,    (uint8_t)0x00, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_PKTCHUNKSIZE,   (uint8_t)0x0D, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_PKTACCEPTFLAGS, (uint8_t)0x39, rxbuf); //original 20, 3f=accept all errors
    ax5043SPIWriteRegister(spip, AX5043_REG_DACVALUE1,      (uint8_t)0x00, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_DACVALUE0,      (uint8_t)0x00, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_DACCONFIG,      (uint8_t)0x00, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_REF,            (uint8_t)0x03, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_XTALOSC,        (uint8_t)0x04, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_XTALAMPL,       (uint8_t)0x00, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_0xF1C,          (uint8_t)0x07, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_0xF21,          (uint8_t)0x68, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_0xF22,          (uint8_t)0XFF, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_0xF23,          (uint8_t)0x84, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_0xF26,          (uint8_t)0x98, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_0xF34,          (uint8_t)0x28, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_0xF35,          (uint8_t)0x11, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_0xF44,          (uint8_t)0x25, rxbuf);

    ax5043SPIWriteRegister(spip, AX5043_REG_PINFUNCIRQ,     (uint8_t)0x03, rxbuf);
    ax5043SPIWriteRegister(spip, AX5043_REG_PKTSTOREFLAGS,  (uint8_t)0x14, rxbuf);
}
