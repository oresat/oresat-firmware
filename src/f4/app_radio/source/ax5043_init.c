...
void ax5043_init(SPIDriver * spip)
{
    ...
    ax5043_phy_chanpllrng[0] = ax5043_read_reg(spip, AX5043_REG_PLLRANGINGA, (uint8_t)0x00, ret_value);
    chprintf(DEBUG_CHP, "\r\r PLL ranging done. 0x%x --\r\n", ax5043_phy_chanpllrng[0]);
    ...
    */
    ...
    ax5043_read_reg(spip, AX5043_REG_PLLRANGINGA, (uint8_t)(ax5043_phy_chanpllrng[0] & 0x0F), ret_value);
