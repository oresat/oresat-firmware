...
ax5043_regval_t reg_values[] = {
  ...
  {AX5043_REG_ENCODING,            0x01,common},
  ...
  // {AX5043_REG_MATCH0LEN,           0x9F,common},
  // {AX5043_REG_MATCH0MAX,           0x1F,common},
