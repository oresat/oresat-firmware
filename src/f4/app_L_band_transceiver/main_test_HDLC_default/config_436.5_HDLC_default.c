...
__reentrantb void ax5043_set_registers(void) __reentrant
{
	...
	radio_write8(AX5043_REG_FRAMING,             0x24);
...
const uint32_t __code axradio_framing_ack_timeout = 14; // 19.0ms in wtimer0 units (640Hz)
...
const uint32_t __code axradio_sync_slave_rxtimeout = 505; // 15.4ms, maximum duration of a packet
