...
__reentrantb void ax5043_set_registers(void) __reentrant
{
	...
	radio_write8(AX5043_REG_PKTADDRCFG,          0x00);
	radio_write8(AX5043_REG_PKTLENCFG,           0x00);
	radio_write8(AX5043_REG_PKTLENOFFSET,        0x08);
...
//framing
const uint8_t __code axradio_framing_maclen = 2;
...
const uint32_t __code axradio_framing_ack_timeout = 11; // 15.5ms in wtimer0 units (640Hz)
...
const uint32_t __code axradio_sync_slave_rxtimeout = 426; // 13.0ms, maximum duration of a packet
