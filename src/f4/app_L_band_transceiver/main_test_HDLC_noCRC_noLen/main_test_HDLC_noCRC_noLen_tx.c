...
ax5043_regval_t reg_values[] = {
  ...
  {AX5043_REG_FRAMING,             0x04,common},  // HDLC 0x04, Pattern 0x06 (both NO CRC)
  ...
  {AX5043_REG_MODCFGA,             0x05,common},  // PA diff 0x05, PA SE 0x06 (both with R.C.)
  ...
  {AX5043_REG_PKTLENCFG,           0x00,common},  // Custom value, pg 65
  {AX5043_REG_PKTLENOFFSET,        0x08,common},
  {AX5043_REG_PKTMAXLEN,           0xC8,common},  // Custom value, pg 65
  ...
  {AX5043_REG_TMGRXPREAMBLE2,      0x17,common},  // HDLC 0x17, Pattern 0x35
  {AX5043_REG_RSSIABSTHR,          0xE3,common},
  {AX5043_REG_BGNDRSSITHR,         0x00,common},
  {AX5043_REG_PKTCHUNKSIZE,        0x0D,common},
  {AX5043_REG_PKTACCEPTFLAGS,      0x20,common},  // Custom value, pg 71
...
// Main loop - Tx Test Packet
static void main_loop(void)
{

    struct axradio_address remoteaddr_tx = {
        { 0x33, 0x34, 0x00, 0x00}
    };

    uint8_t demo_packet[] =  { 0x86, 0xA2, 0x40, 0x40, 0x40, 0x40, 0x60, 0x96, 0x8E, 0x6E, 0xB4, 0xAC, 0xAC, 0x61, 0x3F, 0xF0, 0x3A, 0x43, 0x51, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x3A, 0x54, 0x65, 0x73, 0x74, 0x7B, 0x30, 0x30, 0x30, 0x30, 0x31 };
    uint8_t framing_insert_counter = 1;
    uint8_t framing_counter_pos = 0;
    uint16_t pkt_counter = 0;

    while (true)
    {

        uint8_t demo_packet_[sizeof(demo_packet)];
