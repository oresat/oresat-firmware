...
__reentrantb void ax5043_set_registers(void) __reentrant
{
	...
	radio_write8(AX5043_REG_FRAMING,             0x04);
...
const uint32_t __code axradio_sync_slave_rxadvance[] = { 313, 265, 310 };// 9.526ms, 8.061ms, 9.435ms
const uint32_t __code axradio_sync_slave_rxwindow[] = { 327, 231, 321 }; // 9.954ms, 7.024ms, 9.772ms
