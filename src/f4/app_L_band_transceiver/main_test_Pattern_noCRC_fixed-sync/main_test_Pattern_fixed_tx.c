...
ax5043_regval_t reg_values[] = {
  ...
  {AX5043_REG_MATCH0PAT3,          0x55,common},  // 0x55 Tx, 0xCC Rx
  {AX5043_REG_MATCH0PAT2,          0x33,common},  // 0x33 Tx, 0xAA Rx
  {AX5043_REG_MATCH0PAT1,          0x55,common},  // 0x55 Tx, 0xCC Rx
  {AX5043_REG_MATCH0PAT0,          0x33,common},  // 0x33 Tx, 0xAA Rx
  ...
  {AX5043_REG_PKTADDRMASK1,        0x00,local_address},  // 0x00 Tx, 0xFF Rx
