...
// TX: fcarrier=505.000MHz dev=  2.500kHz br= 10.000kBit/s pwr=-10.0dBm
// RX: fcarrier=505.000MHz bw= 15.000kHz br= 10.000kBit/s
...
ax5043_regval_t reg_values[] = {
  ...
  {AX5043_REG_MAXRFOFFSET0,        0x23,common},
  ...
  {AX5043_REG_PLLVCOI,             0x93,common},
...
ax5043_confval_t conf_values[]={
  ...
  {AXRADIO_PHY_CHANFREQ                ,0x1f900001},
  {AXRADIO_PHY_CHANPLLRNGINIT          ,0x03},
  {AXRADIO_PHY_CHANVCOIINIT            ,0x93},
  {AXRADIO_PHY_CHANPLLRNG              ,0},
  {AXRADIO_PHY_CHANVCOI                ,0},
  {AXRADIO_PHY_VCOCALIB                ,0},
  {AXRADIO_PHY_MAXFREQOFFSET           ,3177},
...
static AX5043Config axcfg1 =
{
  ...
  reg_values,
  conf_values,
  AX5043_MODE_CW, // AX5043_MODE_CW, AX5043_MODE_TX, AX5043_MODE_RX
  &radio1_rx_mb,
};
AX5043Driver axd1;
