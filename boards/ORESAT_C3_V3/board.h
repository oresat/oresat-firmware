...
#define VAL_GPIOC_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOC_VERIFY_TURN) |\
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOC_UHF_IRQ) |    \
...
#define VAL_GPIOC_PUPDR             (PIN_PUPDR_FLOATING(GPIOC_VERIFY_TURN) |\
                                     ...
                                     PIN_PUPDR_FLOATING(GPIOC_UHF_IRQ) |    \
