...
/*
 * ACS V1.1 STM32F042K6 Board Configuration
 * PART: STM32F042K6T6
 * PACKAGE: LQFP32
 */
 ...
 * Board identifier.
 */
#define BOARD_ORESAT_RWB_V1_1
#define BOARD_NAME                  "Oresat RWB V1.1"
 ...
 * PA6  - CAN_SILENT                (output pulldown).
