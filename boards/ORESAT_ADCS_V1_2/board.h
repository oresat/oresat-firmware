...
/*
 * OreSat ACS V4 Board Configuration
 * PART: STM32F091CC
 * PACKAGE: LQFP32
 */
 ...
 */
#define GPIOA_LED                   0U
#define GPIOA_MT_STBY_RST           1U
#define GPIOA_USART2_TX             2U
#define GPIOA_USART2_RX             3U
#define GPIOA_MT_ILIM               4U
#define GPIOA_MT_X_ISENSE           5U
#define GPIOA_MT_Y_ISENSE           6U
#define GPIOA_MT_Z_ISENSE           7U
...
#define GPIOB_MT_Z_PHASE            0U
#define GPIOB_IMU_INT2              1U
#define GPIOB_MT_Y_PHASE            2U
#define GPIOB_MAG_N_FAULT           3U
#define GPIOB_MAG_N_EN              4U
#define GPIOB_MAG_READY             5U
#define GPIOB_I2C1_SCL              6U
#define GPIOB_I2C1_SDA              7U
#define GPIOB_MT_EN                 8U
#define GPIOB_IMU_INT4              9U
...
#define VAL_GPIOA_MODER             (PIN_MODE_OUTPUT(GPIOA_LED) |           \
                                     PIN_MODE_OUTPUT(GPIOA_MT_STBY_RST) |          \
                                     PIN_MODE_ALTERNATE(GPIOA_USART2_TX) |  \
                                     PIN_MODE_ALTERNATE(GPIOA_USART2_RX) |  \
                                     PIN_MODE_ANALOG(GPIOA_MT_ILIM) |          \
                                     PIN_MODE_ANALOG(GPIOA_MT_X_ISENSE) |          \
                                     PIN_MODE_ANALOG(GPIOA_MT_Y_ISENSE) |          \
                                     PIN_MODE_ANALOG(GPIOA_MT_Z_ISENSE) |          \
...
#define VAL_GPIOA_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOA_LED) |        \
                                     PIN_OTYPE_PUSHPULL(GPIOA_MT_STBY_RST) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOA_USART2_TX) |  \
                                     PIN_OTYPE_PUSHPULL(GPIOA_USART2_RX) |  \
                                     PIN_OTYPE_PUSHPULL(GPIOA_MT_ILIM) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOA_MT_X_ISENSE) |       \
...
#define VAL_GPIOA_OSPEEDR           (PIN_OSPEED_HIGH(GPIOA_LED) |           \
                                     PIN_OSPEED_HIGH(GPIOA_MT_STBY_RST) |          \
                                     PIN_OSPEED_HIGH(GPIOA_USART2_TX) |     \
                                     PIN_OSPEED_HIGH(GPIOA_USART2_RX) |     \
                                     PIN_OSPEED_HIGH(GPIOA_MT_ILIM) |          \
                                     PIN_OSPEED_HIGH(GPIOA_MT_X_ISENSE) |          \
                                     PIN_OSPEED_HIGH(GPIOA_MT_Y_ISENSE) |          \
                                     PIN_OSPEED_HIGH(GPIOA_MT_Z_ISENSE) |          \
...
#define VAL_GPIOA_PUPDR             (PIN_PUPDR_PULLDOWN(GPIOA_LED) |        \
                                     PIN_PUPDR_FLOATING(GPIOA_MT_STBY_RST) |       \
                                     PIN_PUPDR_PULLUP(GPIOA_USART2_TX) |    \
                                     PIN_PUPDR_PULLUP(GPIOA_USART2_RX) |    \
                                     PIN_PUPDR_FLOATING(GPIOA_MT_ILIM) |       \
                                     PIN_PUPDR_FLOATING(GPIOA_MT_X_ISENSE) |       \
                                     PIN_PUPDR_FLOATING(GPIOA_MT_Y_ISENSE) |       \
                                     PIN_PUPDR_FLOATING(GPIOA_MT_Z_ISENSE) |       \
...
#define VAL_GPIOA_ODR               (PIN_ODR_LOW(GPIOA_LED) |               \
                                     PIN_ODR_HIGH(GPIOA_MT_STBY_RST) |             \
                                     PIN_ODR_HIGH(GPIOA_USART2_TX) |        \
                                     PIN_ODR_HIGH(GPIOA_USART2_RX) |        \
                                     PIN_ODR_HIGH(GPIOA_MT_ILIM) |             \
                                     PIN_ODR_HIGH(GPIOA_MT_X_ISENSE) |             \
                                     PIN_ODR_HIGH(GPIOA_MT_Y_ISENSE) |             \
                                     PIN_ODR_HIGH(GPIOA_MT_Z_ISENSE) |             \
...
#define VAL_GPIOA_AFRL              (PIN_AFIO_AF(GPIOA_LED, 0U) |           \
                                     PIN_AFIO_AF(GPIOA_MT_STBY_RST, 0U) |          \
                                     PIN_AFIO_AF(GPIOA_USART2_TX, 1U) |     \
                                     PIN_AFIO_AF(GPIOA_USART2_RX, 1U) |     \
                                     PIN_AFIO_AF(GPIOA_MT_ILIM, 0U) |          \
                                     PIN_AFIO_AF(GPIOA_MT_X_ISENSE, 0U) |          \
                                     PIN_AFIO_AF(GPIOA_MT_Y_ISENSE, 0U) |          \
                                     PIN_AFIO_AF(GPIOA_MT_Z_ISENSE, 0U))
 ...
 * PB15 - IMU_INT3                  (input).
 */
#define VAL_GPIOB_MODER             (PIN_MODE_OUTPUT(GPIOB_MT_Z_PHASE) |          \
                                     PIN_MODE_INPUT(GPIOB_IMU_INT2) |       \
                                     PIN_MODE_OUTPUT(GPIOB_MT_Y_PHASE) |          \
                                     PIN_MODE_INPUT(GPIOB_MAG_N_FAULT) |      \
                                     PIN_MODE_OUTPUT(GPIOB_MAG_N_EN) |        \
                                     PIN_MODE_INPUT(GPIOB_MAG_READY) |      \
                                     PIN_MODE_ALTERNATE(GPIOB_I2C1_SCL) |   \
                                     PIN_MODE_ALTERNATE(GPIOB_I2C1_SDA) |   \
                                     PIN_MODE_OUTPUT(GPIOB_MT_EN) |          \
                                     PIN_MODE_INPUT(GPIOB_IMU_INT4) |       \
...
#define VAL_GPIOB_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOB_MT_Z_PHASE) |       \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOB_MT_Y_PHASE) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOB_MAG_N_FAULT) |  \
                                     PIN_OTYPE_PUSHPULL(GPIOB_MAG_N_EN) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOB_MAG_READY) |  \
                                     PIN_OTYPE_OPENDRAIN(GPIOB_I2C1_SCL) |  \
                                     PIN_OTYPE_OPENDRAIN(GPIOB_I2C1_SDA) |  \
                                     PIN_OTYPE_PUSHPULL(GPIOB_MT_EN) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOB_IMU_INT4) |   \
...
#define VAL_GPIOB_OSPEEDR           (PIN_OSPEED_HIGH(GPIOB_MT_Z_PHASE) |          \
                                     ...
                                     PIN_OSPEED_HIGH(GPIOB_MT_Y_PHASE) |          \
                                     PIN_OSPEED_HIGH(GPIOB_MAG_N_FAULT) |     \
                                     PIN_OSPEED_HIGH(GPIOB_MAG_N_EN) |        \
                                     PIN_OSPEED_HIGH(GPIOB_MAG_READY) |     \
                                     PIN_OSPEED_HIGH(GPIOB_I2C1_SCL) |      \
                                     PIN_OSPEED_HIGH(GPIOB_I2C1_SDA) |      \
                                     PIN_OSPEED_HIGH(GPIOB_MT_EN) |          \
                                     PIN_OSPEED_HIGH(GPIOB_IMU_INT4) |      \
...
#define VAL_GPIOB_PUPDR             (PIN_PUPDR_FLOATING(GPIOB_MT_Z_PHASE) |       \
                                     ...
                                     PIN_PUPDR_FLOATING(GPIOB_MAG_N_FAULT) |  \
                                     PIN_PUPDR_FLOATING(GPIOB_MAG_N_EN) |     \
                                     PIN_PUPDR_FLOATING(GPIOB_MAG_READY) |  \
                                     PIN_PUPDR_FLOATING(GPIOB_I2C1_SCL) |   \
                                     PIN_PUPDR_FLOATING(GPIOB_I2C1_SDA) |   \
                                     PIN_PUPDR_FLOATING(GPIOB_MT_EN) |       \
                                     PIN_PUPDR_FLOATING(GPIOB_IMU_INT4) |   \
...
#define VAL_GPIOB_ODR               (PIN_ODR_LOW(GPIOB_MT_Z_PHASE) |             \
                                     ...
                                     PIN_ODR_HIGH(GPIOB_MAG_N_FAULT) |        \
                                     PIN_ODR_LOW(GPIOB_MAG_N_EN) |           \
                                     PIN_ODR_HIGH(GPIOB_MAG_READY) |        \
                                     PIN_ODR_HIGH(GPIOB_I2C1_SCL) |         \
                                     PIN_ODR_HIGH(GPIOB_I2C1_SDA) |         \
                                     PIN_ODR_LOW(GPIOB_MT_EN) |             \
                                     PIN_ODR_HIGH(GPIOB_IMU_INT4) |         \
...
#define VAL_GPIOB_AFRL              (PIN_AFIO_AF(GPIOB_MT_Z_PHASE, 0U) |          \
                                     ...
                                     PIN_AFIO_AF(GPIOB_MAG_N_FAULT, 0U) |     \
                                     PIN_AFIO_AF(GPIOB_MAG_N_EN, 0U) |        \
                                     PIN_AFIO_AF(GPIOB_MAG_READY, 0U) |     \
                                     PIN_AFIO_AF(GPIOB_I2C1_SCL, 1U) |      \
                                     PIN_AFIO_AF(GPIOB_I2C1_SDA, 1U))
#define VAL_GPIOB_AFRH              (PIN_AFIO_AF(GPIOB_MT_EN, 0U) |          \
